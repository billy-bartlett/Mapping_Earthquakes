...
let torontoData = "https://raw.githubusercontent.com/billy-bartlett/Mapping_Earthquakes/main/torontoRoutes.json";
...
d3.json(torontoData).then(function(data) {
  ...
  L.geoJSON(data, {
    ...
    onEachFeature: function(feature, data) {
        console.log(data);
        data.bindPopup("<h2>" + "Airline: " + feature.properties.airline + "</h2>" + "<hr />" +
